...
public class CategoryTest {
    ...
    public void givenAnInValidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError(){
        final String expectedName = "Curabitur eu orci risus. Donec cursus sem vitae ligula convallis lacinia. Mauris " +
                "vulputate ultrices libero in lobortis. Ut at orci dictum, laoreet est nec, aliquam turpis. Suspendisse " +
                "aliquam est pellentesque lobortis convallis asasasasas asas as as as as as as as as as as ";
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
